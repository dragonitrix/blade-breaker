ig.module('game.entities.sword')
    ...
    .defines(function () {
        EntitySword = ig.Entity.extend({
            ...
            manf: new ig.Image('media/manf.png'),
            ...
            draw: function () {
                ...
                switch (this.player) {
                    case 0:
                        this.man.draw((this.pos.x - ig.system.width / 6 * 1 + 30) * 0.5, 0);
                        break;
                    case 1:
                        this.manf.draw((this.pos.x - ig.system.width / 6 * 5 - 30) * 0.5, 0);
                        break;
                    default:
                        break;
                }
...
/*
                ...
                ctx.moveTo(this.offset, 2.5 * ((this.player == 0) ? 1 : -1));
                ctx.lineTo(this.offset + (this.length * this.health), 2.5 * ((this.player == 0) ? 1 : -1));
                ctx.stroke();
